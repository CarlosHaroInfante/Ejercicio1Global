...
namespace Ejercicio1Global.Dtos
{
    internal class ClientesDto
    {
        ...
        public ClientesDto(long id, string nombre, string apellidos, DateTime fechaDeNacimiento, string dni, string correoElectronico, bool esValido, DateTime fechaInicioSuspension, DateTime fechaFinSuspensión, long bibliotecaId)
        {
            this.id = id;
            this.nombre = nombre;
